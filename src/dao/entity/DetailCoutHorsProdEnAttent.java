 ...
 */
@Entity
@Table(name="Detail_COUT_HORS_PROD_EN_ATTENT")
@NamedQuery(name="DetailCoutHorsProdEnAttent.findAll", query="SELECT d FROM DetailCoutHorsProdEnAttent d")
public class DetailCoutHorsProdEnAttent implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name="id_cout_hors_production")
	private CoutHorsProdEnAttent coutHorsProductionEnAttente;
	...
	public CoutHorsProdEnAttent getCoutHorsProductionEnAttente() {
		return coutHorsProductionEnAttente;
	}

	public void setCoutHorsProductionEnAttente(CoutHorsProdEnAttent coutHorsProductionEnAttente) {
		this.coutHorsProductionEnAttente = coutHorsProductionEnAttente;
	}
